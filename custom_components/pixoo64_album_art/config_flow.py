...
_LOGGER.info("pixoo64_album_art config_flow.py: File loaded and initial imports complete.")
_LOGGER.debug("config_flow.py successfully loaded and parsed by Python interpreter.")


class ConfigFlow(config_entries.ConfigFlow, domain="pixoo64_album_art"):
    ...
    async def async_step_user(self, user_input=None):
        ...
        _LOGGER.info(f"pixoo64_album_art config_flow.py: ConfigFlow.async_step_user called with user_input: {user_input}")
        errors = {}
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Required("media_player", default="media_player.living_room"): str,
                vol.Required("pixoo_ip"): str,
...
#         """Manage the options."""
#         _LOGGER.info(f"pixoo64_album_art config_flow.py: Pixoo64AlbumArtOptionsFlowHandler.async_step_init called with user_input: {user_input}")
#         if user_input is not None:
